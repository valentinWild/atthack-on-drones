...
public class TileSpawner : MonoBehaviour
{
    ...
    private void SpawnTile(Tile tile, bool spawnObstacle = true)
    {
        ...
        if (spawnObstacle && currentTiles.Count > 4 && !turnTiles.Contains(tile.gameObject))
        {
            SpawnObstacle();
        }
    }
    ...
    private void SpawnObstacle()
    {
        ...
        */
        ...
        Vector3 newObstaclePosition = new Vector3(currentTileLocation.x, currentTileLocation.y + 20f, currentTileLocation.z);
